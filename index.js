...
// Will return an array with only two elements in it:[first_name, last_name]
function getFirstAndLastName( fullName ) {
    // If a person has a space in their first name, then first_name needs to ignore that first space. 
    // Surnames generally do not have spaces in them so count the number of elements in the array after the split and merge all before the last element.
