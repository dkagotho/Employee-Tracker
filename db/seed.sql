...
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Carol", "Solomon", 1, null);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Kay", "Liz", 2, 1);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Dany", "Cally", 2, 1);

INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Martha", "Syl", 3, null);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Angelina", "Tempo", 4, 3);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Kaylee", "Frye", 4, 3);
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Peter", "Paul", 4, 3);
...
INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("Diana", "Rain", 9, null);
